...
export default function DashboardPage() {
  ...
  // Filter for user's own questions (non-public or questions without author)
  const userQuestions = mockQuestions.filter(q => !q.author || !q.isPublic);
  ...
  const handleDelete = (id: string) => {
    ...
    alert(`Delete question ${id} (placeholder)`);
  };
